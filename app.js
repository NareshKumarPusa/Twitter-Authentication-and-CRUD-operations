...
const sqlitconst express = require("express");
...
// get all likes of a tweet with tweet id if the user follows the twitter
...
// get all replies of a tweet with tweet id if the user follows the twitter
...
// get all the tweets by the logged user
